...
class productCard extends React.Component {
  constructor(props) {
    ...
    this.state = { activeListCartBtn: false };
  }
  ...
  render() {
    ...
    return (
      <div
        ...
        onClick={this.props.productCardOnClick}
        onMouseEnter={onMouseEnter}
        onMouseLeave={onMouseLeave}
        data-id={this.props.product.id}
      >
        {this.state.activeListCartBtn && (
          <button className="listAddToCartBtn">{addToCartIcon}</button>
        )}
